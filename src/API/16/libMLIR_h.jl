...
function mlirCreateConversionMemRefToLLVMConversionPass()
    @ccall mlir_c.mlirCreateConversionMemRefToLLVMConversionPass()::MlirPass
end

function mlirRegisterConversionMemRefToLLVMConversionPass()
    @ccall mlir_c.mlirRegisterConversionMemRefToLLVMConversionPass()::Cvoid
end
...
function mlirCreateGPUGPULowerMemorySpaceAttributesPass()
    @ccall mlir_c.mlirCreateGPUGPULowerMemorySpaceAttributesPass()::MlirPass
end

function mlirRegisterGPUGPULowerMemorySpaceAttributesPass()
    @ccall mlir_c.mlirRegisterGPUGPULowerMemorySpaceAttributesPass()::Cvoid
end
...
function mlirSparseTensorEncodingAttrGet(ctx, numDimLevelTypes, dimLevelTypes, dimOrdering, higherOrdering, pointerBitWidth, indexBitWidth)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGet(ctx::MlirContext, numDimLevelTypes::intptr_t, dimLevelTypes::Ptr{MlirSparseTensorDimLevelType}, dimOrdering::MlirAffineMap, higherOrdering::MlirAffineMap, pointerBitWidth::Cint, indexBitWidth::Cint)::MlirAttribute
end
...
function mlirSparseTensorEncodingAttrGetHigherOrdering(attr)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGetHigherOrdering(attr::MlirAttribute)::MlirAffineMap
end
...
function mlirCreateSparseTensorPostSparsificationRewrite()
    @ccall mlir_c.mlirCreateSparseTensorPostSparsificationRewrite()::MlirPass
end

function mlirRegisterSparseTensorPostSparsificationRewrite()
    @ccall mlir_c.mlirRegisterSparseTensorPostSparsificationRewrite()::Cvoid
end
